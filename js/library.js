...
function normalizeShelf(shelf) {
    ...
    return {
        ...
        decorations:
            Array.isArray(shelf.decorations)
                ? shelf.decorations.map(normalizeDecoration)
                : []
    };
...
function normalizeDecoration(decoration) {
    ...
    return {
        ...
        y:
            clamp(
                Number(decoration.y) || 50,
                5,
                95
            ),

        scale:
            Number(decoration.scale) || 1,

        rotate:
            Number(decoration.rotate) || 0
    };
...
function normalizeBook(book) {
    ...
    return {
        ...
        year:
            numericOrBlank(book.year),

        pages:
            numericOrZero(book.pages),
...
function populateShelfForm(shelf) {
...
function populateShelfDrawerTitle(editing) {
...
function readBookForm(existing = null) {
...
function getSortedBooksForShelf(shelf) {
...
function fitSpineTitle(bookElement) {
...
function getDecorationArtwork(type) {
    ...
    const art = {
        ...
        flowers: `
            ...
            ${createFlowerMarkup("one")}
            ${createFlowerMarkup("two")}
            ${createFlowerMarkup("three")}
        `,
...
function renderRevealCover(book) {
...
function renderJournalBookInfo(book) {
...
function buildJournalEntry(section) {
...
function renderFeaturedReading(book) {
